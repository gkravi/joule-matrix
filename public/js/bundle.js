...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"registerUser.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"enrollment.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.testEnrollment = void 0;
...
// type is either 'password' or 'data'
var testEnrollment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Enrollment successfull!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function testEnrollment(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.testEnrollment = testEnrollment;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"approveTest.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.approveAllTest = exports.approveRejectTest = void 0;
...
// type is either 'password' or 'data'
var approveRejectTest = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "/api/v1/tests/".concat(testSlug, "/approve");
            message = data.isApproved === 'Accepted' ? 'Approved' : 'Rejected';
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Test ".concat(message, "!"));
              window.setTimeout(function () {
  ...
  return function approveRejectTest(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.approveRejectTest = approveRejectTest;

var approveAllTest = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tenant, testId) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "/api/v1/tests/".concat(testId, "/approveAll");
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "All Tests Approved for this Tenant!");
              window.setTimeout(function () {
                location.assign("/enrolls/".concat(tenant, "/").concat(testId));
              }, 1500);
            }
  ...
  return function approveAllTest(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.approveAllTest = approveAllTest;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"test.js":[function(require,module,exports) {
"use strict";
...
var _approveTest = require("./approveTest");
...
var enrollForm = document.querySelector('.form--enroll');
var enrollButton = document.querySelector('.form--enroll .enroll__submit--btn');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var triggerTestButton = document.querySelector('.btn--trigger');
var approvalForm = document.querySelector('.form--approve');
var acceptButton = document.querySelector('.btn--approve');
var rejectButton = document.querySelector('.btn--reject');
var approveAllButton = document.querySelector('.btn--approve-all'); // DELEGATION
...
if (approveAllButton) approveAllButton.addEventListener('click', function (e) {
  e.preventDefault();
  var tenant = approveAllButton.dataset.tenant;
  var testId = approveAllButton.dataset.testid;
  (0, _approveTest.approveAllTest)(tenant, testId);
});
...
if (approvalForm) {
  acceptButton.addEventListener('click', function (e) {
    ...
    var slugId = acceptButton.dataset.testid;
    (0, _approveTest.approveRejectTest)(data, slugId);
  });
  rejectButton.addEventListener('click', function (e) {
    ...
    var slugId = rejectButton.dataset.testid;
    (0, _approveTest.approveRejectTest)(data, slugId);
  });
}

if (triggerTestButton) triggerTestButton.addEventListener('click', function (e) {
  e.preventDefault();
  var assetTypeButton = document.querySelector('#assettype');
  var testSlug = triggerTestButton.dataset.testid;
  var assetType = assetTypeButton ? document.querySelector('#assettype').value : triggerTestButton.dataset.assettype;
  var type;
  if (assetType === 'DiffImage') type = 'imagediff';else if (assetType === 'SourceAsset' || assetType === 'TargetAsset') type = 'screenshot';else if (assetType === 'SourceHtml' || assetType === 'TargetHtml') type = 'webscraping';else if (assetType === 'DiffHtml') type = 'htmldiff';else if (assetType === 'SpeedTest') type = 'speedtest';
  console.log("assetType ".concat(assetType, " and type ").concat(type, " slug ").concat(testSlug));
  var data = {
    assetType: assetType,
    type: type,
    threshold: 0
  };
  (0, _test.triggerTest)(data, testSlug);
});
if (registerForm) registerForm.addEventListener('submit', function (e) {
  ...
  (0, _registerUser.registerUser)(data);
});
if (enrollForm) enrollButton.addEventListener('click', function (e) {
  e.preventDefault();
  var testTypes = [];
  ...
  if (document.getElementById('qa').checked) {
    var urls = Array.prototype.slice.call(document.querySelectorAll('.qa_url')).map(function (el) {
      return el.value;
    });
    var approverEmails = Array.prototype.slice.call(document.querySelectorAll('.qa_email')).map(function (el) {
      return el.value;
    });
    var env = {
      environment: 'qa',
  ...
  if (document.getElementById('stage').checked) {
    var _urls = Array.prototype.slice.call(document.querySelectorAll('.stage_url')).map(function (el) {
      return el.value;
    });

    var _approverEmails = Array.prototype.slice.call(document.querySelectorAll('.stage_email')).map(function (el) {
      return el.value;
    });
    ...
    environments.push(_env);
  }

  if (document.getElementById('prod').checked) {
    var _urls2 = Array.prototype.slice.call(document.querySelectorAll('.prod_url')).map(function (el) {
      return el.value;
    });

    var _approverEmails2 = Array.prototype.slice.call(document.querySelectorAll('.prod_email')).map(function (el) {
      return el.value;
    });
    ...
    var _env2 = {
      environment: 'prod',
      urls: _urls2,
      approverEmails: _approverEmails2,
      testTypes: testTypes
    };
    environments.push(_env2);
  }
  ...
  (0, _enrollment.testEnrollment)(data);
});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38133" + '/');
